...
def test_valid_confidence_accepts_range():
    ...
    sc = SemanticClassification(semantic_type=SemanticType.EMAIL, confidence=0.85, evidence=(ev,), detector="d1", suggestions=(s2, s1))
...
def test_suggestion_ordering_and_immutability():
    ...
    sc = SemanticClassification(semantic_type=SemanticType.LOCATION, confidence=0.6, suggestions=(s1, s2))
