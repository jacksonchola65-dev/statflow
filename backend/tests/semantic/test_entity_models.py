...
def test_invalid_source_column_trim_and_empty():
    with pytest.raises(ValueError):
        EntityCandidate(
            name="E", semantic_types=(SemanticType.PERSON,), source_columns=("   ",), confidence=0.5
        )
...
def test_malformed_semantic_type():
    with pytest.raises(TypeError):
        EntityCandidate(
            name="E", semantic_types=("notatype",), source_columns=("c",), confidence=0.5
        )
